...
* https://commoncriteria.github.io/pp-template/master/FDEEE-release-linkable.pdf[Collaborative Protection Profile for Full-Disk Encryption - Authorization Acquisition] (pdf)
